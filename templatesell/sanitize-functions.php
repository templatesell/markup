 ...
 */
function markup_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function markup_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function markup_sanitize_number_range( $number, $setting ) {
 ...
 *  @since Springy 1.0.0
 */
if (!function_exists('markup_sanitize_number')) :
    function markup_sanitize_number($input)
    {
 ...
 *
 */
if ( !function_exists('markup_sanitize_image') ) :
	function markup_sanitize_image( $image, $setting ) {
		/*
